  ...
  return (
    <div className="">
      <div className="w-screen h-screen overflow-hidden flex items-center justify-center">
        <button
          onClick={() => setMapType(mapType === 0 ? 1 : 0)}
          className="fixed bottom-10 right-10 p-2 rounded-full cursor-pointer transition-all border border-muted-text text-muted-text text-xl hover:bg-muted-text hover:text-white"
        >
          {mapType === 0 ? <FiPenTool /> : <FaSatellite />}
        </button>
        <motion.div
        ...
        >
          <img
            src={mapType === 0 ? "/map/map.png" : "/map/map-illustrated.png"}
            alt="Map"
            className="block w-full h-auto opacity-50 object-contain select-none pointer-events-none"
          />
          ...
          <svg
            id="Roads"
            className="absolute inset-0 w-full h-full z-20 pointer-events-none stroke-primary/30 stroke-3 fill-transparent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1126.38 635.38"
          >
            <path
              id="Road1"
              d="M2.59,310.05s36.71-62.82,44.47-70.59,42.35-36.35,51.53-45.18,26.65-21.53,32.03-40.15,7.85-29.56,9.97-46.15,13.06-37.76,13.06-37.76L196.83,2.29"
            />
            <path
              id="Road2"
              d="M73.88,217.82s0,8.24,5.88,12.71,9.53,5.53,11.65,6.35,13.29-.59,16.71-10.24,8.59-12.24,11.06-12.82,45.06,2,45.06,2l116.47,12.35,124.59,12.71,77.29,8.47,51.18,5.38s44.94,4.97,51.53,5.68,33.88,7.06,45.88,14.12,40,24.47,42.82,28,31.29,27.53,38.59,36.47,38.82,55.06,38.82,55.06l3.26,3.14,8.59,8.15s14.74,12.97,31.76,19.41,35.12,10.15,50.91,8.38,33.44-7.24,42.09-11.56,27.71-17.38,27.71-17.38l35.38-29.38,57.26-46.94s39.26-32.65,44.91-37.41,39.71-26.12,50.29-29.65,21.73-7.76,21.73-7.76"
            />
            <path d="M131.47,152.87s7.71-13.24,12.71-15.82,13.12-5,20.29-3.12,18.35,12.71,18.35,12.71c0,0,29.32,20.38,34.26,23.47s25.5,12.97,25.5,12.97c0,0,31.24,11.56,39,13.85s37.94,7.94,43.76,8.29,33.41,1.35,39.41.29,27.35-4.29,29.18-4.29,31.12-3.18,31.12-3.18c0,0,60.94-7.53,64.94-8.12s28.59-4.59,36.47-4.71,38.82,1.53,55.18,7.18,34.47,12.94,34.47,12.94c0,0,34.74,12.24,44.26,13.74s34.32,4.76,37.59,6,21.09,9.62,30.97,19.15,31.76,40.41,31.76,40.41l30.15,40.68,7.06,9.87s24.32,32.51,56.32,32.98,57.18-18.12,57.18-18.12l67.53-55.29,33.76-27.29,27.65-21.76,25.53-21.06s26.99-14.82,59.43-20.24" />
            <path d="M580.35,634.09s-31.06-64.98-4.24-128.51,112.94-225.18,112.94-225.18c0,0,43.06-87.53,50.82-111.18s23.38-67.06,23.38-67.06c0,0,22.5-77.29,49.09-99.88" />
          </svg>
        </motion.div>
      </div>
